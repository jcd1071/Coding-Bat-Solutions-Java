...
public String withoutEnd(String str) {
    ...
    String result = str.substring(1,len);
    return result;
}
...
public String nonStart(String a, String b) {
    int len1 = a.length();
    String one = a.substring(1,len1);
  
    int len2 = b.length();
    String two = b.substring(1,len2);
...
public String left2(String str) {
    ...
    String two = str.substring(2,last);
    return two+one;
}
...
public String middleTwo(String str) {
    int len = str.length();
    String res = str.substring(((len/2)-1),((len/2)+1));
    return res;
}
...
public String nTwice(String str, int n) {
    ...
    String back = str.substring((len-n),len);
    return front + back;
}
...
public String twoChar(String str, int index) {
    int len = str.length();
    String result ="";
    if (index>=len || index<0 || (index+2)>len) {
...
public String middleThree(String str) {
    int len = str.length();
    String one = str.substring((len/2-1),len/2+2);
    return one;
}
...
public String conCat(String a, String b) {
    ...
    if(result.charAt(check-1) == result1.charAt(0)){
        result=result.substring(0,(check-1));
    }
...
public String lastTwo(String str) {
    ...
    String a = str.substring((len-2), len-1);
    String b = str.substring((len-1),len);
    result = str.substring(0,(len-2)) + b +a;
...
longer string so it is the same length as the shorter string. So "Hello" and "Hi" 
...
the original string. The string may be any length. If there are fewer than 2 chars, 
...
public String withoutX2(String str) {
    ...
    if(str.charAt(0) == 'x' || str.charAt(1)=='x'){
        ...
        if(str.charAt(0)!='x' && str.charAt(1)=='x'){
            extra = str.substring(0,1);
            result = extra + str.substring(2,len);
        }
